...
public class Material_mngSch {
	...
	public Material_mngSch() {
		// TODO Auto-generated constructor stub
	}
	public Material_mngSch(String mnum, int count, int pageSize, int curPage, int pageCount, int start, int end,
