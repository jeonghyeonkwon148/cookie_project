...
<div class="container">
	...
	<div class="input-group mb-3">	
		...
		<input name="num" class="form-control"  value="${customer.num}" readonly/>	
	</div>	
	<div class="input-group mb-3">	
		<div class="input-group-prepend ">
			<span class="input-group-text  justify-content-center">거래처명</span>
		</div>
		<input name="cname" class="form-control"   value="${customer.cname}"   />	
	</div>		
	<div class="input-group mb-3">	
		<div class="input-group-prepend ">
			<span class="input-group-text  justify-content-center">담당자명</span>
		</div>
		<input name="manager" class="form-control"   value="${customer.manager}"   />	
	</div>		
	<div class="input-group mb-3">	
		<div class="input-group-prepend ">
		...
		<c:if test="${sessionScope.auth == 2 && sessionScope.deptno == 30}">
           <input type="button" id="uptBtn" class="btn btn-primary" value="수정" />
			...
			<input type="button" class="btn btn-info" 
				onclick="location.href='customerList'" 
